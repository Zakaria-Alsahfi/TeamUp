//
//  PublicGamesCell.swift
//  SeniorProject
//
//  Created by zakaria alsahfi on 11/2/18.
...
class PublicGameCell: UICollectionViewCell {
    ...
    func addViews(){
        ...
        distanceLabel.centerYAnchor.constraint(equalTo: profileImage.centerYAnchor, constant: -15).isActive = true
        distanceLabel.rightAnchor.constraint(equalTo: rightAnchor, constant: -10).isActive = true
        ...
        parentStackView.topAnchor.constraint(equalTo: gameImage.bottomAnchor, constant: 10).isActive = true
